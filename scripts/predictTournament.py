            ...
            if round == 'R68':
                ...
                for region in regions:
                    ...
                    for team in self.df.loc[(self.df['REGION'] == region) & (self.df['POSTSEASON'] == 'R68')]['School']:
                        teams = [self.df.loc[(self.df['REGION'] == region) & (self.df['POSTSEASON'] != round ) & (self.df["SEED"] == self.df.loc[df["School"] == team].SEED.values[0])]['School'].values[0], team]
                        temp.append(teams)
                    r68[region] = temp
                generated[round] = r68
...
tournament = Tournament(df, None, 2015)
